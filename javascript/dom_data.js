...
const DOM_DATA_JS_TAG       = DOM_DATA_JS_ID  +" (200303:18h)";
...
:!start explorer "http://xahlee.info/comp/unicode_computing_symbols.html"
...
const SYMBOL_ELLIPSIS             = "\u2026"; /* … ellipsis */
...
const SYMBOL_TOOLS_EXTRA_ON       = SYMBOL_LEFT_CHEVRON;
const SYMBOL_TOOLS_EXTRA_OFF      = SYMBOL_RIGHT_DBL_A_BRK;
...
/*{{{*/
    ...
    return {
        ...
        , SYMBOL_TOOLS_EXTRA_ON
        , SYMBOL_TOOLS_EXTRA_OFF
