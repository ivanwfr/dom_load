...
const DOM_GUTTER_JS_TAG     = DOM_GUTTER_JS_ID  +" (200206:14h)";
...
/*}}}*/
    ...
    DOM_GUTTER_LOG = DOM_GUTTER_LOG || dom_store.t_store_getBool("DOM_GUTTER_LOG");
    DOM_GUTTER_TAG = DOM_GUTTER_TAG || dom_store.t_store_getBool("DOM_GUTTER_TAG");
...
return { name : "dom_gutter"
    , logging : function(value) { if(value != undefined) DOM_GUTTER_LOG = value; dom_store.t_store_set_value("DOM_GUTTER_LOG", DOM_GUTTER_LOG); return DOM_GUTTER_LOG; }
    , tagging : function(value) { if(value != undefined) DOM_GUTTER_TAG = value; dom_store.t_store_set_value("DOM_GUTTER_TAG", DOM_GUTTER_TAG); return DOM_GUTTER_TAG; }
    , t_gutter_IMPORT
