...
/* globals window, document, console, Document, Node, Set */

/* exported dom_util, DOM_UTIL_JS_TAG */

const DOM_UTIL_JS_ID    = "dom_util_js";
const DOM_UTIL_JS_TAG   = DOM_UTIL_JS_ID  +" (230707:21h:44)";  /* eslint-disable-line no-unused-vars */
/*}}}*/
...
/*{{{
console.log("get_tool("+id+"): ...return ["+(el ? (el.id || el.tagName) : null)+"]");
}}}*/
    return el;
};
/*}}}*/
...
"...           $RPROFILES/script/stub/dom_util.js
